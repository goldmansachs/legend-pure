...
import org.finos.legend.pure.m2.relational.serialization.grammar.v1.antlr.RelationMappingGraphBuilder;
import org.finos.legend.pure.m2.relational.serialization.grammar.v1.antlr.RelationMappingLexer;
import org.finos.legend.pure.m2.relational.serialization.grammar.v1.processor.RelationExpressionInstanceSetImplementationProcessor;
import org.finos.legend.pure.m2.relational.serialization.grammar.v1.unloader.RelationExpressionInstanceSetImplementationUnbind;
import org.finos.legend.pure.m2.relational.serialization.grammar.v1.validator.RelationExpressionInstanceSetImplementationValidator;
...
public class RelationMappingParser implements Parser
{
    ...
    public String parseMapping(boolean useFastParser, String content, String id, String extendsId, String setSourceInfo, boolean root, String classPath, String classSourceInfo, String mappingPath, String sourceName, int offset, String importId, ModelRepository repository, Context context)
    {
        ...
        org.finos.legend.pure.m2.relational.serialization.grammar.v1.antlr.RelationMappingParser parser = initAntlrParser(useFastParser, content, sourceInformation);

        try
        {
            RelationMappingGraphBuilder visitor = new RelationMappingGraphBuilder(importId, sourceInformation, null);
            org.finos.legend.pure.m2.relational.serialization.grammar.v1.antlr.RelationMappingParser.MappingContext c = parser.mapping();
    ...
    {
        return FastList.newListWith(new RelationExpressionInstanceSetImplementationProcessor());
    }
    ...
    public RichIterable<MatchRunner> getUnLoadUnbinders()
    {
        ...
        return FastList.newListWith(new RelationExpressionInstanceSetImplementationUnbind());
    }

    @Override
    public RichIterable<MatchRunner> getValidators()
    {
        return FastList.newListWith(new RelationExpressionInstanceSetImplementationValidator());
    }
    ...
    private static org.finos.legend.pure.m2.relational.serialization.grammar.v1.antlr.RelationMappingParser initAntlrParser(boolean fastParser, String code, AntlrSourceInformation sourceInformation)
    {
        ...
        org.finos.legend.pure.m2.relational.serialization.grammar.v1.antlr.RelationMappingParser parser = new org.finos.legend.pure.m2.relational.serialization.grammar.v1.antlr.RelationMappingParser(new CommonTokenStream(lexer));
